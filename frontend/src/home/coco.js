...
export default function Coco() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const coconuts = allProducts.filter(product => product.type === "Cocount Product");
    ...
    return (
        <div>
            ...
            <div className="container mt-5">
                <h2 className='text-center border-bottom fw-bold'>Coconut Products</h2>
                <div className="row">
                    {coconutProducts.map(product => (
                                ...
                                <div class="content">
                                    <div class="left">
                                        ...
                                        <div class="product_details">
                                            ...
                                            <p class="price">Rs {(product.price - (product.price * product.discount / 100)).toFixed(2)} <span class="price_original">RS : {product.price}</span> <span class="offer">{product.discount}% OFF</span></p>
